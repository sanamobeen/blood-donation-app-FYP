...
urlpatterns = [
    ...
    path('<uuid:sos_id>/share/', views.share_sos_request, name='share_sos_request'),
    path('check-donation-eligibility/', views.check_donation_eligibility, name='check_donation_eligibility'),
